...
Note: Import the [task 1 json file](https://github.com/srujana-egov/n8n_experiments/blob/main/Task1/Task1_%20High-Risk%20Pregnancy%20%2B%20Diabetes%20Screening%20(3).json) in n8n to run the workflow and to see the node logic. Postman collection is also given in [task 1 postman collection](https://github.com/srujana-egov/n8n_experiments/blob/main/Task1/n8n%20-%20task1.postman_collection.json).
